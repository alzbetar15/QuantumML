...
import torch
import numpy as np
from CNN import complex_ReLU, complex_MaxPool1d
...
def testModel(CNN,filename):
    ...
    X_test_torch = torch.tensor(X_test, dtype=torch.cfloat)
...
if __name__ == "__main__":
    name = 'CNN_models\\2023-11-15\model210C0.6135052442550659.pkl'
    model =loadModel(name)
    print(model)

    oldData = 'CNN_Data\data2023-11-15_14.30.30.838375.pkl'
