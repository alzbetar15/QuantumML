...
n_feature = 2
batch_size = 25
def Benchmarking_CNN(dataset, input_size, optimizer):
    ...
    f = open('result_CNN_SNR3_d100000.txt', 'a')
...
steps = 200
print('running')
dataset = sin_generator.sin_gen(3,100000)




Benchmarking_CNN(dataset=dataset, input_size = 256, optimizer='adam')
